package tech.form3.payment.integration;
...
/**
 * This test runs the application in dev mode, which uses a stub version of the DAO
 * which simulates a database.
 * Dev mode is useful for testing and development purposes when a database is not available.
 ...
 *
 * When having a DB integration test (PaymentResourceIntegrationDBTest), a specific integration test
 * running against the stub may not be necessary, but I'm leaving it here for completeness
 */
...
public class PaymentResourceIntegrationStubTest {
   ...
   */
  @Test
  public void testMapping() throws JsonProcessingException, Exception {
