...
public class PaymentServiceTest {
  ...
  public void testGetAll() {
    tech.form3.payment.domain.Payment payment1 = tech.form3.payment.domain.Payment.builder()
      .withId("4ee3a8d8-ca7b-4290-a52c-dd5b6165ec43")
      .withType(tech.form3.payment.domain.PaymentType.PAYMENT)
      .withVersion(0)
      .withOrganisationId("743d5b63-8e6f-432e-a8fa-c5d8d2ee5fcb")
      .build();
    tech.form3.payment.domain.Payment payment2 = tech.form3.payment.domain.Payment.builder()
  ...
  public void testGetById() throws PaymentNotFoundException {
    tech.form3.payment.domain.Payment payment = tech.form3.payment.domain.Payment.builder()
      .withId("52611302-0758-4f69-aa15-c5f55ab7c3eb")
      .withType(tech.form3.payment.domain.PaymentType.PAYMENT)
      .withVersion(1)
      .withOrganisationId("743d5b63-8e6f-432e-a8fa-c5d8d2ee5fcb")
  ...
  public void testCreate() throws PaymentAlreadyExistentException {
    Payment newPayment = Payment.builder()
      ...
      .withOrganisationId("743d5b63-8e6f-432e-a8fa-c5d8d2ee5fcb")
      .build();
    tech.form3.payment.domain.Payment domainPayment = tech.form3.payment.domain.Payment.builder()
      .withId("4ee3a8d8-ca7b-4290-a52c-dd5b6165ec43")
      .withType(tech.form3.payment.domain.PaymentType.PAYMENT)
      .withVersion(0)
      .withOrganisationId("743d5b63-8e6f-432e-a8fa-c5d8d2ee5fcb")
  ...
  public void testUpdate() throws PaymentNotFoundException, InvalidInputException {
    ...
    tech.form3.payment.domain.Payment domainPayment = tech.form3.payment.domain.Payment.builder()
      ...
      .withOrganisationId("743d5b63-8e6f-432e-a8fa-c5d8d2ee5fcb")
      .build();
    tech.form3.payment.domain.Payment domainUpdatedPayment = tech.form3.payment.domain.Payment.builder()
      .withId("4ee3a8d8-ca7b-4290-a52c-dd5b6165ec43")
      .withType(tech.form3.payment.domain.PaymentType.PAYMENT)
      .withVersion(5)
      .withOrganisationId("00000000-8e6f-432e-a8fa-c5d8d2ee5fcb")
