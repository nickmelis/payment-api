...
@JsonDeserialize (builder = DebtorParty.Builder.class)
...
public class DebtorParty {
  ...
  /**
   * Creates builder to build {@link DebtorParty}.
   *
  ...
  /**
   * Builder to build {@link DebtorParty}.
   */
  public static final class Builder {
    ...
    public DebtorParty build() {
      return new DebtorParty(this);
    }
  }
}