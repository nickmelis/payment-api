...
public class PaymentMapper {
  ...
  public static Payment map(com.cloudfle.payment.domain.Payment domain) {
  ...
  public static com.cloudfle.payment.domain.Payment map(Payment model) {
    com.cloudfle.payment.domain.Payment.Builder builder = com.cloudfle.payment.domain.Payment.builder()
      .withId(model.getId())
