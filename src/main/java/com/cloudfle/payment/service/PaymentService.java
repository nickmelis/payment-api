...
import com.cloudfle.payment.model.mapper.PaymentMapper;
...
public class PaymentService {
  ...
  public Payment getById(String id) throws PaymentNotFoundException {
    Optional<com.cloudfle.payment.domain.Payment> payment = paymentDao.findById(id);
  ...
  public Payment create(Payment newPayment) throws PaymentAlreadyExistentException {
    Optional<com.cloudfle.payment.domain.Payment> payment = paymentDao.findById(newPayment.getId());
    if (payment.isPresent()) {
